  ...
  render() {
    ...
    return (
      ...
      <div className="content">
        ...
        <h4><p>There are currently <span className="important">
          {this.state.participants.length}
        </span> people entered, competing to win <span className="important">
            {this.state.prize} ether</span></p></h4>
        <br></br>
        ...
        <div className="align-items-center">
          <input type="button" value="Enter" className="btn btn-primary btn-lg"
        ...
        <br></br>
        <div className="align-items-center">
          <input type="button" value="Pick a Winner" className="btn btn-success btn-lg"
